...
import com.apd.tema2.io.SimpleRoundReader;
        ...
        return switch (handlerType) {
            ...
            case "simple_n_roundabout" -> new ReaderHandler() {
                ...
                public void handle(final String handlerType, final BufferedReader br) throws IOException {
                    ...
                    int len = line.length;
                    int cars = parseInt(line[0]);
                    int time = parseInt(line[1]);

                    Main.task2 = new SimpleRoundReader(cars, time);
            ...
            case "simple_strict_1_car_roundabout" -> new ReaderHandler() {
                ...
                public void handle(final String handlerType, final BufferedReader br) throws IOException {
                    ...
                    Main.task3 = new SimpleRoundReader(cars, time);
                    Main.intersection = IntersectionFactory.getIntersection("strictRoundabout");
                }
            };
